...
- [ ] Gift a Book — gifts DB table schema + migration
- [ ] Gift a Book — server procedures: createGiftCheckout, redeemGift, myGiftsSent, myGiftsReceived
- [ ] Gift a Book — Stripe webhook handles gift checkout.session.completed (creates gift token)
- [ ] Gift a Book — GiftModal on books section (recipient email + name + personal message)
- [ ] Gift a Book — /gift/:token redemption page (claim book, login gate, success state)
- [ ] Gift a Book — email notification to recipient with redemption link
